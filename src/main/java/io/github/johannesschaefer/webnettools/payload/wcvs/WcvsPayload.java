...
@Data
@Tool(name="wcvs", displayName = "wcvs", cmd="wcvs", description="Web Cache Vulnerability Scanner. Uses the <a href=\"https://github.com/Hackmanit/Web-Cache-Vulnerability-Scanner\">Web-Cache-Vulnerability-Scanner</a> toolkit.")
