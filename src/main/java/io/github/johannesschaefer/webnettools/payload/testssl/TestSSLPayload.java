...
@Data
@Tool(name="testssl", displayName="TestSSL", cmd="testssl", description="Check the support of SSL/TLS of any server. Uses the <a href=\"https://github.com/drwetter/testssl.sh\">drwetter/testssl.sh</a> toolkit.")
