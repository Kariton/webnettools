...
public class PingPayload implements Payload {
    ...
    @BooleanParam(displayName = "DNS", param = "--no-dns", paramType = ParameterType.ONLY_PARAM, description = "Do not resolve host names", labelFalse = "Resolve", labelTrue = "Do not resolve")
