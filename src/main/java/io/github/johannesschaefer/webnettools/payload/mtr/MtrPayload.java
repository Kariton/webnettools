...
public class MtrPayload implements Payload {
    ...
    @MainParameter(displayName = "Hostname or IP address", description = "Specify a hostname or an IP address, e.g. www.example.com or 1.1.1.1")
    ...
    @BooleanParam(displayName = "DNS", param = "--no-dns", paramType = ParameterType.ONLY_PARAM, description = "Do not resolve host names", labelFalse = "Resolve", labelTrue = "Do not resolve", group = MtrPayload.GROUP_GENERAL)
